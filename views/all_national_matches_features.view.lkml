# The name of this view in Looker is "All National Matches Features"
view: all_national_matches_features {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: `oredata-sandbox.world_cup_101_dataset_west2.all_national_matches_features`
    ;;
  ...
  measure: total_t1_total_match_number {
    type: sum
    sql: ${t1_total_match_number} ;;
  }

  measure: average_t1_total_match_number {
    type: average
    sql: ${t1_total_match_number} ;;
  }
